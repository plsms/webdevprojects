...
if numberOfGuesses == 0:
	...
	message = "You have " + str(reds) + " correct digits in the right place, and " + str(whites) + " correct digit(s) in the wrong place. You have had " + str(numberOfGuesses) + " guess(es)."
